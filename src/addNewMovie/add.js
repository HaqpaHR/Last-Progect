...
import addNewField from './nField.html';
  ...
  onAddFieldClick() {
    ...
    this.addField.addEventListener("click", (event) => {
      ...
      if (event.target.closest(".btn-add-field")) {
        this.addNewField = document.createElement("div");
        this.addNewField.className = "form-group row new-fields";
        this.addNewField.innerHTML = addNewField;
        this.addField.appendChild(this.addNewField);
